...
const convertToGeminiFormat = (messages, knowledgeBase) => {
  const contents = [];
  ...
  contents.push({
    role: "model",
    parts: [{
      text: "I understand. I'm BMW Motorrad AI Tour Manager, ready to help plan motorcycle tours while remembering all the details you share with me throughout our conversation."
    }]
  });
  
  // Add conversation history (skip the initial welcome message since it's generated by the bot)
...
const sendMessage = async () => {
  ...
  try {
    ...
    const conversationHistory = convertToGeminiFormat(updatedMessages, knowledgeBase);
